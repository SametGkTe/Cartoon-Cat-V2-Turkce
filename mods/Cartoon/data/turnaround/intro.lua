function onCreate()
    setTimeBarColors('A9ABAC', '')
makeLuaSprite('songscreen','song screens/Turnaround',0,0)
...
makeLuaText('name', 'TURNAROUND', 780, 180, 320)
...
makeLuaText('credi', 'BY TheGrams', 1080, 150, 350)
...
setTextColor('credi', 'A9ABAC')

setTextBorder('name',0,'000000')
setTextBorder('credi',0,'000000')
end
