function onCreate()
    setTimeBarColors('714249', '')
makeLuaSprite('songscreen','song screens/Silver Edge',0,0)
...
makeLuaText('name', 'SILVER EDGE', 780, 180, 320)
...
makeLuaText('credi', 'BY Frander', 1080, 150, 350)
