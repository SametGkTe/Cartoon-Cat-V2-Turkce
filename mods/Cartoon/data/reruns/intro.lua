...
makeLuaSprite('songscreen','song screens/Reruns',0,0)
...
makeLuaText('name', 'RERUNS', 780, 180, 320)
...
makeLuaText('credi', 'BY Sakuroll', 780, 180, 350)
...
doTweenAlpha('songscreen2', 'camHUD', 1, 0.1, 'sineInOut');
doTweenAlpha('vignetteog', 'vignetteog', 1, 0.05, 'sineInOut');
end
function onStepHit()
if curStep == 6 then
