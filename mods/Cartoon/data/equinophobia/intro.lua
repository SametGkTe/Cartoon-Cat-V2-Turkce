...
makeLuaSprite('songscreen','song screens/Equinophobia',0,0)
...
makeLuaText('name', 'EQUINOPHOBIA', 780, 180, 320)
...
makeLuaText('credi', 'BY STA & Sakuroll', 1080, 150, 350)
