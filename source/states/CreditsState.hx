...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['HasanBey',				'bf',			'Boyfriend / New Rigel Records Kurucusu',						 'https://www.tiktok.com/@hasanbey5656',		'D1CBC7'],
			...
			['Defne',				'siren',			'Siren Kafa (Kadın)',						 'https://www.tiktok.com/@nrr_offical8',		'8F2234'],
			['Programcılar'],
			...
			['Temsilciler'],
			['Serdar',				'rigel',			'Temsilci',						 'https://www.tiktok.com/@nrr_offical8',		'C2BDB8'],
			['Batuhan',				'rigel',			'Temsilci',						 'https://www.tiktok.com/@nrr_offical8',		'C2BDB8'],
			['Mete',				'rigel',			'Temsilci',						 'https://www.tiktok.com/@nrr_offical8',		'C2BDB8'],
			['Şeyma',				'rigel',			'Temsilci',						 'https://www.tiktok.com/@nrr_offical8',		'C2BDB8'],
			...
			['Nexus',				'nexus',			'Psych Engine Türkiye Temsilcisi',						 'https://www.tiktok.com/@skynexus0.03',		'14967B'],
			['Syran',				'syran',			'Psych Engine Türkiye Temsilcisi',						 'https://www.tiktok.com/@ssyrann',		'14967B'],
			['Ahmet Tanelan',				'goku',			'Psych Engine Türkiye Temsilcisi',						 'https://www.tiktok.com/@hh.kk7828',		'14967B'],
			['Cartoon Cat V2'],
			['Keneth YT',				'bf',			'Orjinal Cartoon Cat Yapımcısı / All Credits To',						 'https://m.youtube.com/@kenethyt1373',		'14967B'],
